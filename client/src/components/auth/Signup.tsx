        ...
        <AuthLayout>
            <div className="space-y-6">
                <div className="text-center">
                    ...
                    <p className="text-sm text-white/60">Join the campus navigation community</p>
                </div>

                <form onSubmit={handleSignup} className="space-y-4">
                    {/* Full Name Input */}
                    <div>
                        <label htmlFor="fullName" className="block text-xs font-semibold text-white/70 mb-2 uppercase tracking-wider">
                            Full Name
                        </label>
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-white/40 mt-1 ml-1">Must be at least 8 characters</p>
                    </div>

                    {/* Confirm Password Input */}
                    <div>
                        <label htmlFor="confirmPassword" className="block text-xs font-semibold text-white/70 mb-2 uppercase tracking-wider">
                            Confirm Password
                        </label>
                        <div className="relative">
                            <input
