        ...
        <div className="flex-1 overflow-y-auto px-6 pb-8" style={{
          ...
          <section className="mt-10">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="text-xs text-[#137fec] font-bold hover:opacity-80">Clear All</button>
            </div>
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#137fec]/10 flex items-center justify-center text-[#137fec] group-hover:bg-[#137fec] group-hover:text-white transition-colors">
      ...
      <main className="flex-1 relative bg-[#101922] overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[35%] left-[58%] flex flex-col items-center">
            <div className="bg-[#101922]/90 backdrop-blur-sm px-3 py-1.5 rounded-lg shadow-2xl mb-2 border border-[#137fec]/30">
              <p className="text-[11px] font-bold text-white uppercase tracking-wider">Engineering Hall</p>
            </div>
            <div className="w-10 h-10 bg-[#137fec] rounded-full border-4 border-[#101922] shadow-2xl flex items-center justify-center glow-marker">
          ...
          <div className="absolute top-[52%] left-[42%] flex flex-col items-center">
            <div className="w-9 h-9 bg-orange-500 rounded-full border-4 border-[#101922] shadow-2xl flex items-center justify-center">
        ...
        <div className="absolute bottom-8 right-8 flex flex-col gap-3">
          ...
          <div className="flex flex-col bg-[#101922]/90 backdrop-blur-md rounded-2xl shadow-2xl border border-[#242f3d] overflow-hidden divide-y divide-[#242f3d]">
            <button className="w-12 h-12 flex items-center justify-center hover:bg-[#1a242d] transition-colors text-gray-100">
